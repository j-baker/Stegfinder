...
\begin{texdocclassmethods}
\texdocmethod{public}{void}{export}{(LinkedList\textless{}ImageRecord\textgreater{} image, String fileName)}{Exports the provided data to a CSV file. Only images that have been tested are processed.}{\begin{texdocparameters}
...
\begin{texdocclassconstructors}
\texdocconstructor{public}{Export}{(String fileName, boolean csv, boolean pdf)}{Initialize a new export object, ready to export to file.}{\begin{texdocparameters}
...
\end{texdocclassconstructors}
\begin{texdocclassmethods}
\texdocmethod{public}{void}{exportToFiles}{(LinkedList\textless{}ImageRecord\textgreater{} tableData)}{Exports the data using the information given above.}{}
\texdocmethod{public static}{boolean}{PDFExportAllowed}{()}{To reduce unintentional bugs, this software is bundled with a distribution of LaTeX.
...
\end{texdocclassconstructors}
\begin{texdocclassmethods}
\texdocmethod{public}{void}{export}{(LinkedList\textless{}ImageRecord\textgreater{} table, String outputPath)}{Exports the provided data to a PDF file. Only images that have been tested are processed.}{\begin{texdocparameters}
\texdocparameter{table}{}
\texdocparameter{outputPath}{}
\end{texdocparameters}
}
\end{texdocclassmethods}
\end{texdocclass}
...
\texdocmethod{public}{Export}{getExporter}{()}{}{\texdocreturn{The exporter that can be used to create results reports.}
}
...
\texdocmethod{public}{void}{setStartStopText}{(String string)}{Change the text on the start stop button.}{\begin{texdocparameters}
\texdocparameter{string}{The desired result text.}
\end{texdocparameters}
}
\end{texdocclassmethods}
\end{texdocclass}
...
\end{texdocclassconstructors}
\begin{texdocclassmethods}
\texdocmethod{public}{void}{addQueueItem}{(ImageRecord i)}{Add an item to the queue.}{\begin{texdocparameters}
\texdocparameter{i}{The item that is to be added.}
\end{texdocparameters}
}
\texdocmethod{public}{void}{clearQueue}{()}{Remove all items from the queue.}{}
\texdocmethod{public}{int}{getColumnCount}{()}{Get the number of columns in the table.}{}
\texdocmethod{public}{String}{getColumnName}{(int col)}{Get the name of a column.}{}
\texdocmethod{public}{LinkedList\textless{}ImageRecord\textgreater{}}{getResults}{()}{For continuity, should only be used for read-only tasks.}{\texdocreturn{The contents of the queue.}
}
\texdocmethod{public}{int}{getRowCount}{()}{Get the number of rows in the table$/$items in the queue.}{}
\texdocmethod{public}{Object}{getValueAt}{(int rowIndex, int columnIndex)}{Get the contents of the selected cell.}{}
\texdocmethod{public}{void}{removeQueueItem}{(int i)}{Remove a single item from the queue.}{\begin{texdocparameters}
\texdocparameter{i}{The index of the item that should be removed.}
\end{texdocparameters}
}
...
\begin{texdocclass}{class}{ImageRecord}
\label{texdoclet:com.bakes.aqacomp4.imagetools.ImageRecord}
\begin{texdocclassintro}
\end{texdocclassintro}
\begin{texdocclassconstructors}
\texdocconstructor{public}{ImageRecord}{(String imagePath, StegMethods method)}{}{}
\end{texdocclassconstructors}
\begin{texdocclassmethods}
